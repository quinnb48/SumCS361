...
IMAGE_COMM_FILE = "/Users/quinnbehrens/Documents/GitHub/SumCS361/displayphoto.txt"
WIKI_COMM_FILE = "BotD.txt"

def openImage(url):
    print("displaying image...\n")
    c = open(IMAGE_COMM_FILE, "w")
    c.write(url)
    c.close()
